...
const ServiceAreas: React.FC = () => {
  return (
    <>
      <CommonWrapper>
        <Banner imageUrl={servicesanalysers} title="Service Areas" subtitle="Get concrete for your building project delivered and mixed on-site across SOUTH WEST FLORIDA" secondTitle="as well as  Fort Myers, Lehigh Acres, Estero, Immokalee, Bontia Springs, Ave Maria, Orangetree, and Naples"/>
