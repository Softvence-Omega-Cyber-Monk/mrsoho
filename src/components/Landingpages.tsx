        ...
        <div className="bg-[#F9FAFB] p-6 lg:p-8 rounded-lg shadow-xl mt-[112px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
            ...
            <select
              ...
              required
            >
              <option className=" cursor-pointer" value="">How did you hear about us?</option>
              <option className=" cursor-pointer" value="Google Search">Google Search</option>
              <option className=" cursor-pointer" value="Referral">Referral</option>
              <option className=" cursor-pointer" value="Social Media">Social Media</option>
              <option className=" cursor-pointer" value="Advertisement">Advertisement</option>
