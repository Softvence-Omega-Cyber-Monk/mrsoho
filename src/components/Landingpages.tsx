    ...
    <>
      ...
      <CommonWrapper className="w-full max-w-4xl mx-auto mb-16 lg:mb-24 mt-16 lg:mt-24 px-4">
        <div className="bg-[#F9FAFB] p-6 lg:p-8 rounded-lg shadow-xl mt-[112px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading || !turnstileResponse}
              className="w-full p-3 mt-4 lg:mt-6 bg-yellow-400 text-gray-900 font-extrabold text-base rounded-lg shadow-md hover:bg-yellow-500 transition-colors cursor-pointer disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
      ...
      <div className="relative bg-gray-100 py-16 overflow-hidden md:py-24">
        <div className="mx-auto px-12 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end opacity-100 z-0">
            <img
              src={nobgslish}
              alt="Concrete Truck"
              className="max-w-full h-auto brightness-110 contrast-125"
            />
          </div>
        </div>
      </div>
...
// import traktor from "@/assets/traktor.jpg";
// import nobgslish from '@/assets/nobgslish.png';
// // import nobgslish1 from '@/assets/nobgslish.png';
// import AvatarImage from "@/assets/AvatarImage.png";
// import AvatarImage2 from "@/assets/AvatarImage2.png";
// import AvatarImage3 from "@/assets/AvatarImage3.png";
// import { useSaveAndSendContactMutation } from "@/store/Slices/ContactSlice/contactApi";
