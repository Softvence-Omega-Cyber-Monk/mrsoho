...
const Landingpages = () => {
  ...
  return (
    <>
      ...
      <CommonWrapper className="w-full max-w-4xl mx-auto mb-8 sm:mb-16 lg:mb-20 mt-8 sm:mt-16 lg:mt-20 px-4 sm:px-6 lg:px-8">
        <div className="bg-[#F9FAFB] p-4 sm:p-6 lg:p-8 rounded-lg lg:rounded-xl shadow-xl mt-12 sm:mt-20 lg:mt-24">
          {/* Success State */}
          {isSuccess ? (
            <div className="text-center py-8 sm:py-12 lg:py-16">
              ...
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-800 mt-4 sm:mt-6">
                Thank You!
              </h2>
            ...
            /* Form State */
            <>
              <h2 className="text-green-500 text-sm sm:text-base font-bold mb-2 sm:mb-3 tracking-wider text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 lg:space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                  <input
                    ...
                    required
                    className="w-full p-3 sm:p-4 border border-gray-300 rounded-lg text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-yellow-500"
                  />
                  <input
                    type="tel"
                    name="phone"
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-3 sm:p-4 border border-gray-300 rounded-lg text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-yellow-500 resize-none min-h-[120px]"
                ></textarea>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full p-3 sm:p-4 border border-gray-300 rounded-lg text-sm sm:text-base text-gray-900 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                  required
                >
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full p-3 sm:p-4 mt-4 sm:mt-6 bg-yellow-400 text-gray-900 font-extrabold text-sm sm:text-base rounded-lg shadow-md hover:bg-yellow-500 transition-colors cursor-pointer disabled:opacity-50 active:scale-95"
                >
                  {isLoading ? "Submitting..." : "Submit Contact"}
                </button>
              </form>

              <p className="text-[#848D9B] text-center mt-3 sm:mt-4 text-sm sm:text-base">
      ...
      >
        ...
        <CommonWrapper className="max-w-[1440px] px-4 sm:px-6 lg:px-8">
          <div className="relative w-full min-h-[400px] sm:min-h-[500px] lg:min-h-[640px] flex items-center py-8 sm:py-12">
            <div className="relative z-10 max-w-3xl p-6 sm:p-8 lg:p-10 bg-black/50 rounded-lg text-white mx-auto sm:mx-4 lg:mx-6 w-full">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-[#FEDA42] mb-4 sm:mb-6 max-w-full sm:max-w-md lg:max-w-2xl">
                Do you need a concrete pump?
              </h1>
              <p className="text-base sm:text-lg lg:text-xl leading-relaxed mb-6 sm:mb-8 max-w-full sm:max-w-md lg:max-w-2xl">
              ...
              >
                <button className="px-6 sm:px-8 py-3 sm:py-4 bg-yellow-400 text-gray-900 font-extrabold text-base sm:text-lg rounded-lg shadow-md hover:bg-yellow-500 transition-colors cursor-pointer active:scale-95 w-full sm:w-auto">
                  Get In Touch 
                </button>
              </Link>
            </div>
      ...
      {/* Testimonials Section - FIXED FOR MOBILE */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
            {/* Left Column - Heading */}
            <div className="text-center lg:text-left">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tight text-gray-900 max-w-full lg:max-w-[449px] mx-auto lg:mx-0">
                Trusted by Builders and Homeowners
              </h2>
              <p className="mt-4 sm:mt-6 text-base sm:text-lg text-gray-600 max-w-full lg:max-w-[652px] mx-auto lg:mx-0 leading-relaxed">
            ...
            <div className="space-y-6 sm:space-y-8">
              {/* Testimonial 1 */}
              <div className="bg-white p-4 sm:p-6 lg:p-8 shadow-lg rounded-lg border border-gray-100 w-full">
                ...
                <div className="mt-4 sm:mt-6 flex items-center">
                  <img src={AvatarImage} alt="John D." className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-full flex-shrink-0 object-cover" />
                  <div className="ml-3 sm:ml-4">
                    <p className="text-sm sm:text-base font-semibold text-gray-900">John D.</p>
                    <p className="text-xs sm:text-sm text-gray-500">Commercial Development</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-4 sm:p-6 lg:p-8 shadow-lg rounded-lg border border-gray-100 w-full">
                ...
                <div className="mt-4 sm:mt-6 flex items-center">
                  <img src={AvatarImage2} alt="Sarah L." className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-full flex-shrink-0 object-cover" />
                  <div className="ml-3 sm:ml-4">
                    <p className="text-sm sm:text-base font-semibold text-gray-900">Sarah L.</p>
                    <p className="text-xs sm:text-sm text-gray-500">Residential Driveway</p>
                  </div>
                </div>
              </div>

              {/* Testimonial 3 - COMPLETELY FIXED */}
              <div className="bg-white p-4 sm:p-6 lg:p-8 shadow-lg rounded-lg border border-gray-100 w-full">
                <div className="flex items-center space-x-1 text-yellow-500 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} className="w-4 h-4 sm:w-5 sm:h-5 fill-current" viewBox="0 0 24 24">
                ...
                <div className="mt-4 sm:mt-6 flex items-center">
                  <img src={AvatarImage3} alt="Mike R." className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-full flex-shrink-0 object-cover" />
                  <div className="ml-3 sm:ml-4">
                    <p className="text-sm sm:text-base font-semibold text-gray-900">Mike R.</p>
                    <p className="text-xs sm:text-sm text-gray-500">General Contractor</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Questions Section */}
      <div className="relative bg-[#FBFBFB] py-12 sm:py-16 lg:py-20 overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-12">
            <div className="w-full lg:w-1/2 text-center lg:text-left z-10">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-extrabold text-gray-900 leading-tight mb-4 sm:mb-6">
                Have any questions for us?
              </h2>
              <p className="text-base sm:text-lg text-gray-700 max-w-lg mx-auto lg:mx-0 mb-6 sm:mb-8">
              ...
              <button
                ...
                className="inline-flex items-center cursor-pointer justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-bold rounded-lg bg-yellow-400 text-gray-900 hover:bg-yellow-500 transition duration-300 shadow-lg shadow-yellow-500/40 active:scale-95 w-full sm:w-auto"
              >
            ...
            <div className="w-full lg:w-1/2 flex justify-center lg:justify-end z-0">
              <img
                ...
                alt="Concrete Truck"
                className="max-w-full h-auto max-h-[300px] sm:max-h-[400px] lg:max-h-[500px] brightness-110 contrast-125 opacity-40 lg:opacity-60"
              />
            </div>
          </div>
        </div>
